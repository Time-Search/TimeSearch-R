...
from clip_server.model.siglip_model import SigLIPModel
from clip_server.model.clip_model import CLIPModel
from clip_server.model.tokenization import Tokenizer
from jina import DocumentArray, Executor, requests
from opentelemetry.trace import NoOpTracer, Span
from clip_server.model.pretrained_models import _SIGLIP_MODELS
from clip_server.model.transforms_gpu import PreprocessBlobsToGpu


class CLIPEncoder(Executor):
    def __init__(
        self,
        name: str = 'google/siglip-so400m-patch14-384',
        ...
        **kwargs,
        ...
        if name in _SIGLIP_MODELS or "siglip" in name:
            self._image_transform = PreprocessBlobsToGpu(self._model.image_size, dtype=self._dtype, device=self._device) #siglip_transform_blob(self._model.image_size)
        else:
